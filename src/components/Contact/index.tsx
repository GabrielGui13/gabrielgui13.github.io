    ...
    return (
        <ContainerContact id="contato">
            ...
            <SubContainerContact>
                ...
                <BoxContact href='mailto:gabrielguilherme13@hotmail.com' >
                ...
                <BoxContact target="blank"  href='https://api.whatsapp.com/send?phone=5584999110101' >
                ...
                <BoxCV href={"https://gabrielgui13.github.io/static/media/cvpt.pdf"} download="Gabriel Barbosa - Currículo">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ContainerSocialMedias>
                    <SocialMedia target="blank"  href='https://www.linkedin.com/in/gabrielgui13'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank"  href='https://github.com/gabrielgui13'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank" href='https://instagram.com/gabrielgui13'>
